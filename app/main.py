...
async def download(*,
                    ...
                    axis: str = Query(None,title="axis type",
    ...
    for i in valid_vars:
        ...
        data.append(get_data(resource_url, i, axis))
    ...
    if output_format == 'csv':
        ...
        # the line below will redirect to a download landing page
...
async def plot(*,
    ...
    if get == 'plot':
        if not axis:
            axis='y_axis'
        data = get_data(resource_url, variable, axis)
